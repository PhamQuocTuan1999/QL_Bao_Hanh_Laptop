        ...
        <ul class="navbar-nav">
          <li class="nav-item active">
            <a href="{{ route('admin.login') }}" class="nav-link">
              <i class="material-icons active">dashboard</i> Quản Lý
            </a>
          </li>
          <li class="nav-item ">
            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.login.submit') }}">
              ...
              <div class="card card-login card-hidden">
                <div class="card-header card-header-success text-center">
                  <h4 class="card-title">ĐĂNG NHẬP QUẢN LÝ</h4>

                </div>
                <div class="card-body ">


                  <span class="bmd-form-group" class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                ...
                <div class="card-footer justify-content-center">
                  <button  type="submit" class="btn btn-rose btn-link btn-lg"> Đăng nhập</button>
                </div>
              </div>
            </form>
          </div>
