...
@enderror
  ...
  <div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black" style="background-image: url(img/slide1.jpg); background-size: cover; background-position: top center;">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('register') }}">
              ...
              <div class="card card-login card-hidden">
                ...
                <div class="card-body ">
                  ...
                  <span class="bmd-form-group" >
                    <div class="input-group" class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                      ...
                      <input id="email" type="text" class="form-control"  placeholder="Tên tài khoản" name="email" value="{{ old('email') }}" required autofocus>
                    </div>
                    @if ($errors->has('email'))
                ...
                @endif
                  ...
                  {{--  --}}
                  <span class="bmd-form-group">
                    <div class="input-group" class="form-group{{ $errors->has('kh_hoTen') ? ' has-error' : '' }}">
                      <div class="input-group-prepend">
                        <span class="input-group-text">
                          <i class="material-icons">perm_identity</i>
                        </span>
                      </div>
                      <input id="kh_hoTen" placeholder="Họ Và Tên .."  type="text" class="form-control" name="kh_hoTen" value="{{ old('kh_hoTen') }}" required autofocus>
...
{{--  --}}
<span class="bmd-form-group">
    <div class="input-group" class="form-group{{ $errors->has('kh_email') ? ' has-error' : '' }}">
      <div class="input-group-prepend">
        <span class="input-group-text">
      ...
      <input id="kh_email" placeholder="Gmail..." type="email" class="form-control" name="kh_email" value="{{ old('kh_email') }}" required >
...
<!-- Email -->
<span class="bmd-form-group">
    <div class="input-group" class="form-group{{ $errors->has('kh_diaChi') ? ' has-error' : '' }}">
      <div class="input-group-prepend">
        <span class="input-group-text">
      ...
      <input id="kh_diaChi"placeholder="Địa Chỉ.." type="text" class="form-control" name="kh_diaChi" value="{{ old('kh_diaChi') }}" required>
...
<!-- Điện thoại -->
<span class="bmd-form-group">
    <div class="input-group" class="form-group{{ $errors->has('kh_dienThoai') ? ' has-error' : '' }}">
      <div class="input-group-prepend">
        <span class="input-group-text">
      ...
      <input id="kh_dienThoai" placeholder="Số điện thoại .."  type="number" class="form-control" name="kh_dienThoai" value="{{ old('kh_dienThoai') }}" required autofocus>
...
{{--  --}}
                ...
                <div class="card-footer justify-content-center">
                  <button  type="submit" class="btn btn-rose btn-link btn-lg"> Đăng ký</button>
                </div>
              </div>
            </form>
          </div>
