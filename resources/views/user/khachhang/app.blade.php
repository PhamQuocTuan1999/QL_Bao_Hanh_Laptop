...
<body class="">
    ...
    <div class="wrapper ">
        <div class="sidebar" data-color="purple" data-background-color="White" data-image="../../../../../assets/img/sidebar-4.jpg">
          ...
          -->
          <div class="logo"> <a style="color: #1f88eb;margin-left: 25px;font-size: 20px" href="{{ route('home') }}" class="simple-text logo-normal">
            <i class="material-icons">handyman</i>
            <samp>CTUTECH CẦN THƠ</samp>
        </a></div>

            <div class="sidebar-wrapper" style="background-image: ../../../../../assets/img/sidebar-4.jpg">
                <div class="user">
                ...
                <ul class="nav">
                        ...
                        <li id="id2" class="nav-item   ">
                            <a class="nav-link"  href="{{ route('ds-don') }}">
                                <i class="material-icons">pending_actions</i>
                                <p>Đơn Bảo Hành </p>
                            </a>
                        </li>
                        <li id="id2" class="nav-item   ">
                            <a class="nav-link" href="{{ route('ds-dangky') }}">
                                <i class="material-icons">pending_actions</i>
                                <p>Đơn Gửi Từ Xa</p>
                            </a>
                        </li>
                        <li id="id4" class="nav-item   ">
                            <a class="nav-link" href="{{ route('ds-vanchuyen') }}">
                                <i class="material-icons">pending_actions</i>
                                <p>Đơn Nhận Từ Xa</p>
                            </a>
                        </li>
