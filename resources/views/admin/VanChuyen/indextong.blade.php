            ...
            <ul class="nav nav-pills nav-pills-icons border-bottom border-dark " role="tablist">
                <li class="nav-item">
                    <a class="nav-link active " aria-controls="nav-home" aria-selected="true"
                        ...
                        Danh Sách Đơn Vận Chuyển Từ Khách Hàng
                    </a>
                </li>
            </ul>
        </div>
                                        ...
                                        <th>
                                            ...
                                            class=" bnt btn-default text-lg-center" type="button" id="myInput12" onchange="myFunction12()" >
                                                          ...
                                                          <option value="Đơn phân công">
                                                              Đơn phân công
                                                          </option><option value="Đang Vận chuyển Đi">
                                                            Đang Vận chuyển Đi
                                                        </option>
                                    ...
                                    @foreach ($HoaDon as $key => $HoaDon)
                                        <tr data-entry-id="{{ $HoaDon->hd_ma }}">
                                         ...
                                         @elseif ($HoaDon->hd_trangThai == 4) <a title="{{ $HoaDon->hd_ma }}"
                                                 onclick="myFunction5({{ $HoaDon->hd_ma }})" style="color: rgba(255, 255, 255, 255)"
                                         ...
                                         @elseif ($HoaDon->hd_trangThai == -1) <a title="{{ $HoaDon->hd_ma }}"
                                                 ...
                                                 style="color: rgba(255, 255, 255, 255)" class="btn btn-social btn-fill btn-youtube">Đang Vận chuyển Đến</a>
                                         ...
                                         @endif
                                            ...
                                            <td>
                                                    ...
                                                    <form action="{{ route('user.destroy', $HoaDon->hd_ma) }}"
                                                        method="POST"
                                                        onsubmit="return confirm('{{ trans('Bạn có chắc muốn xóa') }}');"
