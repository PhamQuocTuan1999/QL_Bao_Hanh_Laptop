                    ...
                    <div class="card-body">
                            ...
                            <div class="modal-body">
                                <form method="POST" action="{{ route('manager.Van_Chuyen.store') }}"
                                    ...
                                    <textarea type="hidden" class="d-none" name="id" id="cntt">{{$HoaDon->hd_ma}}</textarea>


                                    <button class="btn btn-social btn-fill btn-behance btn-block col-lg-2" type="submit">Duyệt</button>
