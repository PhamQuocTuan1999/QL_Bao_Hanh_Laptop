                ...
                <div class="col-md-3" style="margin-left: 7%">
                    <div class="card ">
                        <div class="card-header card-header-info card-header-text">
                            ...
                            <h4 class="card-title">Tìm Theo Tên </h4>
                        </div>
                        <div class="card-body ">
                ...
                <div class="col-md-3">
                    <div class="card ">
                        <div class="card-header card-header-danger card-header-text">
                            ...
                            <h4 class="card-title">Tìm Theo Số Điện Thoại </h4>
                        </div>
                        <div class="card-body ">
                            <div class="form-group">
                                <input class="form-control" type="number" id="myInput4" onkeyup="myFunction4()"
                                    placeholder="  " title="T điện thoại">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="card ">
                        <div class="card-header card-header-warning card-header-text">
                            ...
                            <h4 class="card-title">Tìm Theo Địa Chỉ Thoại </h4>
                        </div>
                        <div class="card-body ">
                            <div class="form-group">
                                <input class="form-control" type="
                                        text" id="myInput41" onkeyup="myFunction13()" placeholder="  "
                                    title="T điện thoại">
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script>
        function myFunction13() {
            var input, filter, table, tr, td, i, txtValue;
            input = document.getElementById("myInput41");
            filter = input.value.toUpperCase();
            table = document.getElementById("myTableht");
            tr = table.getElementsByTagName("tr");
            for (i = 0; i < tr.length; i++) {
