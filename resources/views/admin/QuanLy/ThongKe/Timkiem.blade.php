...
?> --}}
        ...
        {{-- ? --}}
        <button class="btn btn-round" data-toggle="modal" data-target="#loginModal1">
            Khách Hàng<i class="material-icons">assignment</i>

        </button>

        <div class="modal fade" id="loginModal1" tabindex="-1" role="">
                ...
                <div class="modal-content">
                    <div class="card card-signup card-plain">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="{{ route('manager.Tim_kiem_show') }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group bmd-form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="kh_hoten" class="form-control"
                                    ...
                                    <div class="form-group bmd-form-group">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text"><i class="material-icons">location_on</i>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group bmd-form-group">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text"><i class="material-icons">calendar_today</i>
                                                </div>
                                            </div>
                                            <input type="date" name="tungay" placeholder="Từ ngày" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group bmd-form-group">
                                        <label for=""></label>
                                ...
                                <div class="modal-footer justify-content-center">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-link btn-wd btn-lg">Tìm Kiếm</button>
                                </div>
        ...
        <button class="btn btn-round" data-toggle="modal" data-target="#loginModal2">
            Login<i class="material-icons">assignment</i>

        </button>

        <div class="modal fade" id="loginModal2" tabindex="-1" role="">
            <div class="modal-dialog modal-login" role="document">
                <div class="modal-content">
                    <div class="card card-signup card-plain">
                        <div class="modal-header">
        ...
        {{--  --}}
        <form method="POST" action="{{ route('manager.tk_tg_show') }}" enctype="multipart/form-data">
            <input type="hidden" class="d-none" name="_method" value="PUT" />
            {{ csrf_field() }}
                ...
                <div class="row">
                            ...
                            <div class="card-body ">
                                <div class="form-group">
                                    <div class='input-group date'>
                                        <input name="tungay" type="date" class="form-control datepicker"
                                            value="{{ old('tungay') }}" required>
                    ...
                    <div class="col-md-5">
                        <div class="card ">
                            ...
                            <div class="card-body ">
                                <div class="form-group">
                                    <input name="denngay" type="date" value="{{ old('denngay') }}"
                            ...
                            <table id="myTableht"
                                ...
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <select class="btn-default text-lg-center" id="myInput12"
                                        ...
                                        <tr data-entry-id="{{ $HoaDon->hd_ma }}">
                                            ...
                                            <td>
                                                ...
                                                @elseif ($HoaDon->hd_trangThai == 0) <a title="{{ $HoaDon->hd_ma }}"
                                                        ...
                                                        style="color: rgba(255, 255, 255, 255)"
                                                        class="btn btn-facebook">Đơn
                                                        phân công</a>
                                                @elseif ($HoaDon->hd_trangThai == -1) <a title="{{ $HoaDon->hd_ma }}"
                                                        data-toggle="modal" data-target="#tt"
                                                        style="color: rgba(255, 255, 255, 255)"
                                                        class="tn btn-social btn-fill btn-youtube">Đang Vận Chuyển Đến </a>
                                                @elseif ($HoaDon->hd_trangThai == -2) <a title="{{ $HoaDon->hd_ma }}"
                                                        data-toggle="modal" data-target="#tt"
                                                        style="color: rgba(255, 255, 255, 255)"
                                                        class="btn btn-social btn-fill btn-twitter">Đang Vận Chuyển Đi</a>
