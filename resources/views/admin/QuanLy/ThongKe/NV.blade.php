                ...
                <div class="col-md-4">
                    <div class="card ">
                        <div class="card-header card-header-rose card-header-text">
                            ...
                            <h4 class="card-title">Thống Kê Theo Nhân Viên Xử Lý</h4>
                        </div>
                        <div class="card-body ">
                            <div class="form-group">
                                <select class="form-control selectpicker col-7 " multiple="multiple" id="myInput20" onchange="myFunction20()"data-style="btn btn-info" name="nv_id">
                                    @foreach ($nv as $loai)
                                        @if (old('nv_id') == $loai->id)
                                            <option value="{{ $loai->nv_hoTen }}" selected>
                                                {{ $loai->nv_hoTen }}
                                            </option>
                                        @else
                                            <option value="{{$loai->nv_hoTen }}">
                                                {{ $loai->nv_hoTen }}
                                            </option>
                                        @endif
                                    @endforeach
