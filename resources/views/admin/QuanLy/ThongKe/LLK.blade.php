...
@section('content')
    ...
    <div style="margin-top:-4%" width="200%" >
        <div class="container-fluid">
            ...
            <form method="POST" action="{{ route('manager.tk_llk_show') }}"
                    ...
                    <div class="col-md-4">
                        <div class="card ">
                            <div class="card-header card-header-rose card-header-text">
                                ...
                                <h4 class="card-title">Thống Kê Theo Loại Linh Kiện</h4>
                            </div>
                            <div class="card-body ">
                                <div class="form-group">
                                    <select class="form-control selectpicker" data-style="btn btn-info" name="llk_ma">
                                        @foreach ($nv as $loai)
                                            @if (old('llk_ma') == $loai->llk_ma)
                                                <option value="{{ $loai->llk_ma }}" selected>
                                                    {{ $loai->llk_ten }}
                                                </option>
                                            @else
                                                <option value="{{$loai->llk_ma }}">
                                                    {{ $loai->llk_ten }}
                                                </option>
                                            @endif
                                        @endforeach
            ...
            <button type="submit"  class="btn btn-info w3-center col-3">Gửi</button>
        </form>
        </div>
