                            ...
                            <table id="myTableht"
                                ...
                                <thead>
                                   ...
                                   >
                                        ...
                                        <th>
                                            <select class=" bnt btn-default text-lg-center" type="button" id="myInput13"
                                            ...
                                            <option value=" KHÔNG HÀI LÒNG">
                                               Không Hài Lòng
                                            </option>

                                            <option value="KHÁ HÀI LÒNG">
                                                Khá Hài Lòng
                                            </option>

                                            <option value="QUÁ HÀI LÒNG">
                                                Quá Hài Lòng
                                            </option>

                                            <option value="CỰC KỲ HÀI LÒNG">
                                               Cực Kỳ Hài Lòng
                                            </option>
                                        ...
                                        <tr data-entry-id="{{ $HoaDon->hd_ma }}">
                                            ...
                                            <td>
                                                ...
                                                @elseif ($HoaDon->hd_trangThai == 5) <a title="{{ $HoaDon->hd_ma }}"
                                                        onclick="myFunction5({{ $HoaDon->hd_ma }})"
                                                        style="color: rgba(255, 255, 255, 255)" class="btn btn-warning">Đơn
                                                        đợi linh kiện</a>
                                            ...
                                            <td>
                                                ...
                                                <a style="margin-top: 10px" class=" btn-social ">KHÁ HÀI LÒNG</a>
                                                <div class="rating"style="height: 80px;" >
                                            ...
                                            {{--  --}}
                                                ...
                                                data-target="#tt" type="button" class="btn btn-social btn-fill btn-pinterest">
                                                    <i class="fa fa-pinterest"></i> Đánh Giá
                                                  </button>
                                                @endif
                                    ...
                                    <form method="POST" action="{{ route('orders.danhgia', $HoaDon->hd_ma) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea required type="text" class="form-control" id="hd_phanHoi" rows="3"
                                                name="hd_phanHoi"> {{ old('hd_phanHoi',$HoaDon->hd_phanHoi) }} </textarea>
                                        </div>
