...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro/examples/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 May 2019 07:46:19 GMT -->
<!-- Added by HTTrack -->
                            ...
                            <ul class="nav">
                                <li class="nav-item ">
                                    <a class="nav-link" href="maps/google.html">
                                        ...
                                        <span class="sidebar-normal"> Tạo Đơn</span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="maps/fullscreen.html">
                                        <span class="sidebar-mini"> FSM </span>
                                        <span class="sidebar-normal">Cập nhật </span>
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link" href="maps/vector.html">
                                        <span class="sidebar-mini"> VM </span>
                                        <span class="sidebar-normal"> Thanh toán </span>
                                    </a>
                                </li>
                            </ul>
                        </div>
